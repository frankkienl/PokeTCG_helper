...
val expansionName = "Wisdom_of_Sea_and_Sky"
val expansionNameImgUrl = "WisdomofSeaandSky"
...
//    val jsonStringExpansion = Res.readBytes("files/expansions/A3b/expansion_eevee_grove.json").decodeToString()
    val jsonStringExpansion = Res.readBytes("files/expansions/A4/expansion_wisdom_of_sea_and_sky.json").decodeToString()
...
//        }
        ...
        // image
        val imageFileName = "${card.pokeName.replace(" ", "")}${expansionNameImgUrl}${card.number}.png"
        val imageUrl = "$bulbaImageUrl$imageFileName"
        println(imageUrl)
        val responseImg = ktorClient.request(imageUrl)
...
suspend fun fixImageUrls() {
    val jsonString = Res.readBytes("files/expansions/A4/expansion_wisdom_of_sea_and_sky.json").decodeToString()
