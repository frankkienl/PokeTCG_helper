...
val expansionName = "SecludedSprings"

@OptIn(ExperimentalResourceApi::class)
suspend fun bulbaScrap2() {
    val ktorClient = HttpClient(CIO)

    val jsonStringExpansion = Res.readBytes("files/expansions/A4a/expansion_secluded_springs.json").decodeToString()
...
//        }
        ...
        val requestImgUrl = "$bulbaImageUrl$imageFileName"
        val responseImg = ktorClient.request(requestImgUrl)
...
suspend fun fixImageUrls() {
    val jsonString = Res.readBytes("files/expansions/A4a/expansion_secluded_springs.json").decodeToString()
